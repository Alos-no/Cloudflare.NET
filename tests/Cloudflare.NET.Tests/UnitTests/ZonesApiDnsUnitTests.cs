...
/// <summary>
///   Contains unit tests for the DNS operations on <see cref="ZonesApi" />.
///   These tests cover the legacy DNS methods exposed through <see cref="IZonesApi" />.
/// </summary>
/// <remarks>
///   For tests of the dedicated DNS API (<see cref="Dns.IDnsApi" />), see <see cref="DnsApiUnitTests" />.
///   For Zone CRUD tests, see <see cref="ZonesApiUnitTests" />.
/// </remarks>
[Trait("Category", TestConstants.TestCategories.Unit)]
public class ZonesApiDnsUnitTests
{
  ...
  public ZonesApiDnsUnitTests(ITestOutputHelper output)
  {
  ...
  #region DNS Record Operations - Request Construction Tests
  ...
  #region DNS Record Operations - Pagination Tests

  /// <summary>
  ///   Verifies that ListAllDnsRecordsAsync handles page-based pagination correctly. Cloudflare's page-based
  ///   pagination uses a `result_info` object with `page` and `total_pages` to control the loop.
  /// </summary>
  [Fact]
