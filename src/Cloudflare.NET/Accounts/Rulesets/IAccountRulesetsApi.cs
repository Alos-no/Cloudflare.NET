...
///   <para>
///     This includes WAF Custom Rules, Rate Limiting Rules, and other advanced configurations that apply across all
///     zones in an account.
///   </para>
/// </summary>
public interface IAccountRulesetsApi
{
  ...
  /// <summary>Lists the version history for a specific phase entrypoint, allowing for manual pagination.</summary>
