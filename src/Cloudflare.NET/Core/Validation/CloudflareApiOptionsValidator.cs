...
/// <summary>
///   Validates <see cref="CloudflareApiOptions" /> to ensure all required configuration is present and valid.
...
/// <remarks>
///   <para>
///     This validator checks that the API token is provided, which is required for authentication with
///     the Cloudflare API. Additional validation (such as AccountId for R2 or GraphQL URL for Analytics)
///     is performed by package-specific validators.
///   </para>
///   <para>
///     The validation errors are designed to be clear and actionable, mentioning "Cloudflare" explicitly
...
///     by default. Factories should use <see cref="ValidateConfiguration" /> directly for explicit
///     validation of named client configurations with custom exception types.
///   </para>
/// </remarks>
public class CloudflareApiOptionsValidator : IValidateOptions<CloudflareApiOptions>
{
  ...
  ///   <see cref="ValidateOptionsResult.Skip" /> for non-default option names, allowing factories
  ///   to handle validation with custom exception types.
  /// </summary>
  ...
  /// <summary>
  ///   Initializes a new instance of the <see cref="CloudflareApiOptionsValidator" /> class with
  ///   default validation requirements (ApiToken required) and default skip behavior for named options.
  /// </summary>
  public CloudflareApiOptionsValidator() : this(CloudflareValidationRequirements.Default, skipNamedOptions: true) { }


  /// <summary>
  ///   Initializes a new instance of the <see cref="CloudflareApiOptionsValidator" /> class with
  ///   specific validation requirements and default skip behavior for named options.
  /// </summary>
  ...
  public CloudflareApiOptionsValidator(CloudflareValidationRequirements requirements)
    : this(requirements, skipNamedOptions: true) { }


  /// <summary>
  ///   Initializes a new instance of the <see cref="CloudflareApiOptionsValidator" /> class with
  ///   specific validation requirements and explicit skip behavior control.
  /// </summary>
  /// <param name="requirements">The validation requirements to apply.</param>
  ...
  /// <summary>
  ///   Validates the specified <see cref="CloudflareApiOptions" /> against the given requirements.
  ///   This method is intended for use by factories to perform explicit validation with proper
  ///   error messages that include the client name.
  /// </summary>
  /// <param name="name">
...
/// <summary>
///   Specifies which properties of <see cref="CloudflareApiOptions" /> are required for validation.
///   This allows different packages (Core, R2, Analytics) to have different validation requirements.
/// </summary>
public sealed class CloudflareValidationRequirements
{
  ...
  /// <summary>
  ///   Gets a value indicating whether the <see cref="CloudflareApiOptions.ApiToken" /> is required.
  ///   Defaults to <see langword="true" />.
  /// </summary>
  public bool RequireApiToken { get; init; } = true;

  /// <summary>
  ///   Gets a value indicating whether the <see cref="CloudflareApiOptions.AccountId" /> is required.
  ///   Defaults to <see langword="false" />.
  /// </summary>
  public bool RequireAccountId { get; init; }

  /// <summary>
  ///   Gets a value indicating whether the <see cref="CloudflareApiOptions.GraphQlApiUrl" /> is required.
  ///   Defaults to <see langword="false" />.
  /// </summary>
  public bool RequireGraphQlApiUrl { get; init; }

  /// <summary>
  ///   Gets a value indicating whether the <see cref="CloudflareApiOptions.ApiBaseUrl" /> is required.
  ///   Defaults to <see langword="false" />.
  /// </summary>
  ...
  #region Properties & Fields - Public (Static)

  /// <summary>
  ///   Default validation requirements: only <see cref="CloudflareApiOptions.ApiToken" /> is required.
  ///   Suitable for the Core API client.
  /// </summary>
  public static CloudflareValidationRequirements Default => new() { RequireApiToken = true };

  /// <summary>
  ///   Validation requirements for the Analytics client: <see cref="CloudflareApiOptions.ApiToken" />
  ///   and <see cref="CloudflareApiOptions.GraphQlApiUrl" /> are required.
  /// </summary>
  ...
  /// <summary>
  ///   Validation requirements for the R2 client: <see cref="CloudflareApiOptions.AccountId" /> is required.
  ///   The API token is not required for R2 data plane operations (uses S3 credentials instead).
  /// </summary>
