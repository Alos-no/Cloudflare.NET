...
public class R2Settings
{
  ...
  /// <summary>
  ///   The default R2 S3 API endpoint URL template. Contains a format placeholder '{0}' for the Account ID.
  ///   This is the standard Cloudflare R2 endpoint: https://{account_id}.r2.cloudflarestorage.com
  /// </summary>
  ...
  /// <summary>
  ///   The R2 S3 API endpoint URL. It must contain a format placeholder '{0}' for the Account ID.
  ///   Defaults to the standard Cloudflare R2 endpoint: https://{account_id}.r2.cloudflarestorage.com
  /// </summary>
