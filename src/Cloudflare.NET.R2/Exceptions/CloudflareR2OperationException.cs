...
/// <summary>
///   Represents an exception thrown for a failed R2 API operation, such as a 404 on a GetObject call or a 403 on a
///   PutObject call.
/// </summary>
public class CloudflareR2OperationException : CloudflareR2Exception
{
  ...
  /// <summary>Initializes a new instance of the <see cref="CloudflareR2OperationException" /> class.</summary>
