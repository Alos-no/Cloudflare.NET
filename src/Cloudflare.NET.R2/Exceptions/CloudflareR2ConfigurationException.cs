...
/// <summary>
///   Represents an exception thrown when the R2 client is misconfigured (e.g., missing
///   credentials).
/// </summary>
public class CloudflareR2ConfigurationException : CloudflareR2Exception
{
  ...
  /// <summary>
  ///   Initializes a new instance of the <see cref="CloudflareR2ConfigurationException" />
  ///   class.
  /// </summary>
