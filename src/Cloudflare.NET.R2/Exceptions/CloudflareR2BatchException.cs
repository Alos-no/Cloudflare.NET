...
/// <summary>
///   Represents an exception thrown during a batch operation (e.g., DeleteObjectsAsync) where some items failed to
///   be processed. This exception contains the list of items that failed, allowing for targeted retries.
/// </summary>
