...
///   An optional but recommended condition to enforce the MIME type of
///   the uploaded file (e.g., "image/jpeg").
/// </param>
/// <param name="ContentLengthRange">
///   An optional but recommended condition to enforce the minimum
///   and maximum size of the uploaded file in bytes.
/// </param>
/// <param name="Conditions">
///   An optional collection of custom S3 Post conditions to include in the
///   policy, allowing for advanced validation scenarios.
/// </param>
/// <param name="HeadersToSign">
///   An optional dictionary of headers to include in the policy, enforcing
///   them on the client-side upload. For POST, these are added as fields in the policy document.
/// </param>
