...
/// <summary>
///   Represents the response from creating a presigned POST URL, which includes the URL to
///   target and the form fields that must be included in the multipart/form-data request.
/// </summary>
